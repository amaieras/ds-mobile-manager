    ...
    setTimeout(() => {
      ...
      this.getClientsPFList().subscribe(clientPF => {
        ...
        this.cols = [
          ...
          {field: 'observation', header: 'Observatii', filter: true, sortable: true},
          {field: 'color', header: 'Culoare', filter: true, sortable: true},
          {field: 'code', header: 'Cod Telefon', filter: true, sortable: true},
